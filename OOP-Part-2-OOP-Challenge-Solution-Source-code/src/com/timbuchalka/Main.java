...
import com.timbuchalka.HealthyBurger;
...
public class Main {
    ...
    public static void main(String[] args) {
		...
		// plus all additional items, each showing the addition name, and addition price, and a grand/final total for the
        ...
        com.timbuchalka.DeluxeBurger db = new com.timbuchalka.DeluxeBurger();
